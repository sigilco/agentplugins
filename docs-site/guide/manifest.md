...
::: tip
Add `"$schema": "https://agentplugins.dev/schema/v1.json"` to JSON manifests for editor autocomplete in VS Code, JetBrains, and any JSON-Schema-aware editor. See the [JSON Schema reference](/reference/schema).
:::
