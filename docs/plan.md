# AgentPlugins — Unified Plugin Library for AI Agent Harnesses
...
- **The Port**: Abstract plugin interface (AgentPlugins API)
...
## Deliverables
- /mnt/agents/output/agentplugins/ — the library source
- /mnt/agents/output/agentplugins-example/ — example consumer project
