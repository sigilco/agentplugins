/**
 * AgentBridge — PlatformAdapter Contract Test Suite
 *
 ...
 *   - adapter-claude: AGENTBRIDGE_HOOK_ID not properly set in inline wrapper scripts
...
describe('PlatformAdapter Contract Suite', () => {
  ...
  describe('Adapter-specific contract deviations (documented as .todo)', () => {
    ...
    // Known bug: claude inline wrapper doesn't set AGENTBRIDGE_HOOK_ID properly
    it('adapter-claude: inline handler wrapper has AGENTBRIDGE_HOOK_ID set', () => {
      ...
      if (wrapperFiles.length > 0) {
        ...
        // Known bug: AGENTBRIDGE_HOOK_ID should be set but may not be
