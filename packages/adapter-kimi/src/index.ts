 ...
 *
 * Platform adapter for Kimi (Moonshot AI) — AgentPlugin plugin system.
 *
...
> Generated by AgentPlugin — Kimi Platform Adapter
...
/**
 * Kimi (Moonshot AI) platform adapter for AgentPlugin.
 *
 * Transforms universal AgentPlugin plugins into the Kimi-native format:
