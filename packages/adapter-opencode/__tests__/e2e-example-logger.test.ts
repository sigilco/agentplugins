 ...
 * This mirrors plugins/example-logger/agentplugin.config.ts.
 */
...
describe("E2E: example-logger manifest compilation", () => {
  ...
  it("should compile successfully", () => {
    ...
    expect(output.manifest.name).toBe("agentplugin-example-logger");
  ...
  it("should generate valid .ts plugin file", () => {
    ...
    expect(tsFile?.path).toBe("agentplugin-example-logger.ts");
  ...
  it("should generate valid opencode.json", () => {
    ...
    expect(json.name).toBe("agentplugin-example-logger");
  ...
  it("should include postInstall instructions", () => {
    ...
    expect(output.postInstall[0]).toContain("agentplugin-example-logger.ts");
