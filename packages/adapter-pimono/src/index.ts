...
declare module "@agentplugin/core" {
...
function compilePlugin(plugin: PluginManifest): AdapterOutput {
  ...
  tsLines.push(` *`);
  tsLines.push(` * This file is auto-generated by @agentplugin/adapter-pimono.`);
 ...
 * Usage:
 * ```ts
 * import { piMonoAdapter } from "@agentplugin/adapter-pimono";
 * import { createBridge } from "@agentplugin/core";
 *
...
/* ────────────────────────────────────────────────────────────────────────────
   Re-exports from @agentplugin/core for consumer convenience
   ──────────────────────────────────────────────────────────────────────────── */
